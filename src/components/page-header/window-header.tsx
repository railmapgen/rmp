...
import { Events, Id, NodeId } from '../../constants/constants';
...
export default function WindowHeader() {
    ...
    const isProMode = isTimelinePage && timeline.mode === 'pro';
    ...
    const canAdjustAnimation = isProMode && selectedNodeEntries.length > 0;
