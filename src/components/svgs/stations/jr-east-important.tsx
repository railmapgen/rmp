...
const JREastImportantStation = (props: StationComponentProps) => {
    ...
    return (
        <g>
            ...
            <g
                id={`stn_name_${id}`}
                transform={`translate(${preciseNameOffsets ? `${preciseNameOffsets.x}, ${preciseNameOffsets.y}` : `${textENDX * scale}, ${textENDY * scale}`})`}
                textAnchor={preciseNameOffsets ? preciseNameOffsets.anchor : textENAnchor}
