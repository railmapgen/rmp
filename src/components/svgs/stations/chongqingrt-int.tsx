    ...
    return (
        <g id={id} transform={`translate(${x-8}, ${y-8})`}>
            <circle
                ...
                className="removeMe"
            />
            <path style={{fill:"white",stroke:"#231815",strokeMiterlimit:22.9,strokeWidth:.232,transform:"scale(2.5)",pointerEvents:"none"}} d="M3.4614974.2162582c1.7925251,0,3.2455526,1.4530487,3.2455526,3.2453842,0,1.792366-1.4530275,3.2453995-3.2455526,3.2453995C1.6690944,6.7070418.21625,5.2540084.21625,3.4616424.21625,1.6693069,1.6690944.2162582,3.4614974.2162582Z"/>
            {
                transfer[0].length<=2 ? 
                    <>
                        <path
                            style={{ fill: transfer[0][0]?transfer[0][0][2]:"gray", fillRule: "evenodd", strokeWidth: 0, transform: "scale(2.5)", pointerEvents: "none" }}
                        ...
                        />
                        <path
                            style={{ fill: transfer[0][1]?transfer[0][1][2]:"gray", fillRule: "evenodd", strokeWidth: 0, transform: "scale(2.5)", pointerEvents: "none" }}
...
const chongqingRTIntStationIcon = (
    <div style={{padding: 5}}>
        <svg viewBox="0 0 7 7" height={30} width={30} focusable={false}>
            <path style={{fill:"none",stroke:"#231815",strokeMiterlimit:22.9,strokeWidth:.232}} d="M3.4614974.2162582c1.7925251,0,3.2455526,1.4530487,3.2455526,3.2453842,0,1.792366-1.4530275,3.2453995-3.2455526,3.2453995C1.6690944,6.7070418.21625,5.2540084.21625,3.4616424.21625,1.6693069,1.6690944.2162582,3.4614974.2162582Z"/>
            <path
