...
const metadata: { [k in FacilitiesType]: { width: number; height: number } } = {
    [FacilitiesType.Airport]: { width: 25, height: 25 },
    [FacilitiesType.Maglev]: { width: 49, height: 16 },
    [FacilitiesType.Disney]: { width: 25, height: 25 },
    [FacilitiesType.Railway]: { width: 49, height: 16 },
    [FacilitiesType.HSR]: { width: 49, height: 16 },
    [FacilitiesType.NgongPing360]: { width: 49, height: 16 },
    [FacilitiesType.AirportHK]: { width: 49, height: 16 },
    [FacilitiesType.DisneyHK]: { width: 49, height: 16 },
    [FacilitiesType.Tiananmen]: { width: 49, height: 16 },
    [FacilitiesType.AirportBJ]: { width: 28, height: 28 },
};
...
const Facilities = (props: NodeComponentProps<FacilitiesAttributes>) => {
    ...
    return React.useMemo(
        () => (
            ...
            //             )}
            //         </g>
            <g id={id} transform={`translate(${x - metadata[type].width / 2}, ${y - metadata[type].height / 2})`}>
                <image
                    width={metadata[type].width}
                    height={metadata[type].height}
                    href={`/images/${type}.svg`}
                    onPointerDown={onPointerDown}
                    onPointerMove={onPointerMove}
                    onPointerUp={onPointerUp}
                    style={{ cursor: 'move' }}
