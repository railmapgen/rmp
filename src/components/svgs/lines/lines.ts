...
import chengduMetroOutsideFareGates from './styles/chengdumetro-outside-fare-gates';
...
export const lineStyles = {
    ...
    [LineStyleType.ChengduMetroOutsideFareGates]: chengduMetroOutsideFareGates,
};
