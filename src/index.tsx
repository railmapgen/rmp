...
const init = () => {
    localStorage.clear();
    window.graph.addNode('stn_1', { x: 250, y: 150, names: ['车站1', 'Stn 1'] });
    window.graph.addNode('stn_2', { x: 250, y: 250, names: ['车站2', 'Stn 2'] });
    window.graph.addNode('stn_3', { x: 250, y: 350, names: ['车站3', 'Stn 3'] });
    window.graph.addNode('stn_4', { x: 150, y: 250, names: ['车站4', 'Stn 4'] });
    window.graph.addNode('stn_5', { x: 350, y: 250, names: ['车站5', 'Stn 5'] });
