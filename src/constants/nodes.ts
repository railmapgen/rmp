...
import type { I18nTextAttributes } from '../components/svgs/nodes/i18n-text';
import type { MasterAttributes } from '../components/svgs/nodes/master';
import type { ImageAttributes } from '../components/svgs/nodes/image';
import type { ShmetroNumLineBadgeAttributes } from '../components/svgs/nodes/shmetro-num-line-badge';
import type { ShmetroTextLineBadgeAttributes } from '../components/svgs/nodes/shmetro-text-line-badge';
import type { GzmtrLineBadgeAttributes } from '../components/svgs/nodes/gzmtr-line-badge';
import type { BjsubwayNumLineBadgeAttributes } from '../components/svgs/nodes/bjsubway-num-line-badge';
import type { BjsubwayTextLineBadgeAttributes } from '../components/svgs/nodes/bjsubway-text-line-badge';
import type { SuzhouRTNumLineBadgeAttributes } from '../components/svgs/nodes/suzhourt-num-line-badge';
import type { BerlinUBahnLineBadgeAttributes } from '../components/svgs/nodes/berlin-u-bahn-line-badge';
import type { BerlinSBahnLineBadgeAttributes } from '../components/svgs/nodes/berlin-s-bahn-line-badge';
import type { ChongqingRTNumLineBadgeAttributes } from '../components/svgs/nodes/chongqingrt-num-line-badge';
import type { ChongqingRTTextLineBadgeAttributes } from '../components/svgs/nodes/chongqingrt-text-line-badge';
import type { ChongqingRTNumLineBadge2021Attributes } from '../components/svgs/nodes/chongqingrt-num-line-badge-2021';
import type { ChongqingRTTextLineBadge2021Attributes } from '../components/svgs/nodes/chongqingrt-text-line-badge-2021';
import type { ShenzhenMetroNumLineBadgeAttributes } from '../components/svgs/nodes/shenzhenmetro-num-line-badge';
import type { MRTDestinationNumbersAttributes } from '../components/svgs/nodes/mrt-dest-num';
import type { MRTLineBadgeAttributes } from '../components/svgs/nodes/mrt-line-badge';
import type { JREastLineBadgeAttributes } from '../components/svgs/nodes/jr-east-line-badge';
