...
import type { ShmetroOsysiStationAttributes } from '../components/svgs/stations/shmetro-osysi';
import type { ShanghaiSuburbanRailwayStationAttributes } from '../components/svgs/stations/shanghai-suburban-railway';
import type { GzmtrBasicStationAttributes } from '../components/svgs/stations/gzmtr-basic';
import type { GzmtrIntStationAttributes } from '../components/svgs/stations/gzmtr-int';
import type { GzmtrInt2024StationAttributes } from '../components/svgs/stations/gzmtr-int-2024';
import type { BjsubwayBasicStationAttributes } from '../components/svgs/stations/bjsubway-basic';
import type { BjsubwayIntStationAttributes } from '../components/svgs/stations/bjsubway-int';
import type { MTRStationAttributes } from '../components/svgs/stations/mtr';
import type { SuzhouRTBasicStationAttributes } from '../components/svgs/stations/suzhourt-basic';
import type { SuzhouRTIntStationAttributes } from '../components/svgs/stations/suzhourt-int';
import type { KunmingRTBasicStationAttributes } from '../components/svgs/stations/kunmingrt-basic';
import type { KunmingRTIntStationAttributes } from '../components/svgs/stations/kunmingrt-int';
import type { MRTBasicStationAttributes } from '../components/svgs/stations/mrt-basic';
import type { MRTIntStationAttributes } from '../components/svgs/stations/mrt-int';
import type { JREastBasicStationAttributes } from '../components/svgs/stations/jr-east-basic';
import type { JREastImportantStationAttributes } from '../components/svgs/stations/jr-east-important';
import type { FoshanMetroBasicStationAttributes } from '../components/svgs/stations/foshan-metro-basic';
import type { QingdaoMetroStationAttributes } from '../components/svgs/stations/qingdao-metro-station';
import type { TokyoMetroBasicStationAttributes } from '../components/svgs/stations/tokyo-metro-basic';
import type { TokyoMetroIntStationAttributes } from '../components/svgs/stations/tokyo-metro-int';
import type { LondonTubeBasicStationAttributes } from '../components/svgs/stations/london-tube-basic';
import type { LondonTubeIntStationAttributes } from '../components/svgs/stations/london-tube-int';
import type { LondonRiverServicesIntStationAttributes } from '../components/svgs/stations/london-river-services-interchange';
import type { GuangdongIntercityRailwayStationAttributes } from '../components/svgs/stations/guangdong-intercity-railway';
import type { ChongqingRTBasicStationAttributes } from '../components/svgs/stations/chongqingrt-basic';
import type { ChongqingRTIntStationAttributes } from '../components/svgs/stations/chongqingrt-int';
import type { ChongqingRTBasicStation2021Attributes } from '../components/svgs/stations/chongqingrt-basic-2021';
import type { ChongqingRTIntStation2021Attributes } from '../components/svgs/stations/chongqingrt-int-2021';
import type { ChengduRTBasicStationAttributes } from '../components/svgs/stations/chengdurt-basic';
import type { ChengduRTIntStationAttributes } from '../components/svgs/stations/chengdurt-int';
import type { OsakaMetroStationAttributes } from '../components/svgs/stations/osaka-metro';
import type { WuhanRTBasicStationAttributes } from '../components/svgs/stations/wuhanrt-basic';
import type { WuhanRTIntStationAttributes } from '../components/svgs/stations/wuhanrt-int';
import type { CsmetroBasicStationAttributes } from '../components/svgs/stations/csmetro-basic';
import type { CsmetroIntStationAttributes } from '../components/svgs/stations/csmetro-int';
import type { HzmetroBasicStationAttributes } from '../components/svgs/stations/hzmetro-basic';
import type { HzmetroIntStationAttributes } from '../components/svgs/stations/hzmetro-int';
